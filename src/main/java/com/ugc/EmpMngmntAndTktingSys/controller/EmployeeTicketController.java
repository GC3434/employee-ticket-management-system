...
//    public ResponseEntity<TicketResponse> getTicketById(@PathVariable Long tktId){
...
//    }
    ...
    public ResponseEntity<TicketResponse> createTicket(@Valid @RequestBody CreateTicketRequest createTicketRequest, Authentication authentication){
        return ResponseEntity.ok(ticketService.createTicket(createTicketRequest,authentication.getName()));
    }
